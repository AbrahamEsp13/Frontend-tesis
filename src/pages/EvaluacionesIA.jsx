...
function EvaluacionesIA() {
  ...
  const generarCuestionario = async () => {
    ...
    try {
      ...
      // Reemplazo de setError/alert de error
  ...
  // Reemplazo del window.confirm para eliminar examen
  ...
  // Reemplazo del window.confirm para borrar pregunta individual
  ...
  // Reemplazo del window.confirm para reiniciar examen
